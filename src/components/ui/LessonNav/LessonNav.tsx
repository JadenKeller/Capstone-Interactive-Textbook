...
export default function LessonNav() {
	...
	return (
		<div className={styles.lessonNav_wrapper}>
			<h3>Lessons</h3>
			<nav className={styles.lessonNav_container}>
				<div className={styles.lessonNav_item} onClick={() => navigate("/lesson/vectors")}>
				...
				<div className={styles.lessonNav_item} onClick={() => navigate("/lesson/vector-operations")}>
				...
				<div className={styles.lessonNav_item} onClick={() => navigate("/lesson/matrices")}>
					<svg width="51" height="50" viewBox="0 0 51 50" fill="none">
